...
You can use the `ai` subcommand with the `--interactive/-i` option to start an interactive Python session with Ibis Birdbrain ready to use:

```bash
$ birdbrain ai --interactive
```
...
[Learn how to work with Ibis Birdbrain in Python](./python.qmd).
